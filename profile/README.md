...
| [risk-navigator](https://github.com/automatiqa-lab/risk-navigator) | Multi-agent operational risk monitoring across freight, fuel, labour, weather, and geopolitics, turned into briefings and a live dashboard | live |
...
| [process-navigator](https://github.com/automatiqa-lab/process-navigator) | A guided canvas that helps you spot automation opportunities in your own processes, with an agent working the board alongside you | pipeline |
